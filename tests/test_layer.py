...
class LayerTest(unittest.TestCase):
    ...
    def test_01_double(self):
        ...
        R = np.array(
            [
                [0.72851, 0.22898, 0.12610, 0.10068],
        ...
        T = np.array(
            [
                [6.44003, 0.21795, 0.12290, 0.09867],
        ...
        R = np.array(
            [
                [0.78844, 0.28216, 0.15973, 0.12840],
        ...
        T = np.array(
            [
                [1.64804, 0.22726, 0.14271, 0.11749],
        ...
        R = np.array(
            [
                [0.79808, 0.30346, 0.17574, 0.14215],
        ...
        T = np.array(
            [
                [0.13566, 0.15475, 0.12350, 0.10763],
    ...
    def test_03_double(self):
        ...
        R = np.array(
            [
                [0.57675, 0.15818, 0.03296, -0.00369],
        ...
        T = np.array(
            [
                [0.01817, 0.06990, 0.03529, 0.00115],
